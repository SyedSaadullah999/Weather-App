...
// geting weather data from API - this logic will fetch the latest weather
...
public class WeatherApp
{
    ...
    public static JSONArray getLocationData(String locationName)
    {
        ...
        String urlString = "https://customer-geocoding-api.open-meteo.com/v1/search?name=" + locationName +  "&count=1&language=en&format=json";
    ...
    public static String getCurrentTime(){
        ...
        // format date to be 2024-11-02T00:00 (this is how is is read in the API)
